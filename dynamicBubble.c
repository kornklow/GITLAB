...
void sortArray(char *array, int count, int maxSize);
void writeArray(char *array,int count, int maxSize, char* outputFilename);
int readArray(char *array, int count, int maxSize, FILE* pFp);
void printArray(char *array, int count, int maxSize);
